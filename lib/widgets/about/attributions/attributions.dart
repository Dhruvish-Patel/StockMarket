...
class Attributions extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BaseList(children: <Widget>[
      _buildContent(
        title: 'Application Developed by Group 6',
        text:
            'Hope you like it\n\n\n\n Inspired from Scam 1992 - The Harshad Mehta Story',
...
//    );
  ...
  Widget _build(BuildContext context) {
    return Image(image: AssetImage('assets/images/scam.png'));
  }
